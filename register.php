              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center mb-4">
                    <h1 class="h4 text-gray-900 font-weight-bold">REGISTER</h1>
                    <span class="text-muted">Sistem Informasi Pegawai</span>
                  </div>
                  <form class="user" method="POST" action="<?= base_url('_config/proses_reg') ?>?register">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Username" autocomplete="off" required autofocus>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block"><i class="fas fa-fw fa-user-plus"></i> Register</button>
                  </form>
                  <hr>
